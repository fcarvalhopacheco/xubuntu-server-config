...
1. Download the borgback installation script by running the following command:: 
...
## Step 3 - Let’s create the first backup (archive)
    ...
    + The following demonstrates how to backup the 'Documents' directory 
    and designate the archive(backup) as docs_archive1
